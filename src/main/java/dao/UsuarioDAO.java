...
/**
 * Clase donde se concentran todas las consultas, altas y modificaciones.  
 * que realicen sobre la tabla Usuarios de la Base de DAtos.
 * 
 * @author Santos
 */
public class UsuarioDAO {
	...
	/**
	 * Verifica si el usuario y la contreseña existen en la base de datos.
	 * 
	 * @param usuario es el Usuario ingresado por el usuario
	 * @param contrasenia es la Contraseña ingresada por el usuario
	 * 
	...
	public Boolean validarUsuarioYPass(String usuario, String contrasenia) {
		try {
			...
			if (resultSet.next()) {   //Si resultSet tiene un elemento, resutlSet.next() devuleve true
				return true;
			}
